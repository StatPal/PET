...
void         ReadItArgs(char *, char *, int *, char *, char *, int *, int *, char *, double *, double *, double *, double *, double *, double *, int *, char *, char *, int *, double *, double *, int *, double *, double *, double *, double *, double *, double *, int *, int *, int *, char *);
